...
def map_values_to_newick(newick, df):
    for index, row in df.iterrows():
        ...
        meta_data = f"&delta={row['delta']},p_value={row['p_value']},decision_corrected_test_tips={row['decision_corrected_test_tips']}, decision_corrected_test_branches={row['decision_corrected_test_branches']}, decision_test_tip2tip={row['decision_test_tip2tip']}"
