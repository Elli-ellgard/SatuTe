...
from graph import (
    Graph,
    Node,
    count_and_nodes_edges,
    convert_tree_to_graph,
    edge_type,
    calculate_subtree_edge_metrics,
)
...
def print_pretty_dict(dictionary):
    """Prints a dictionary in a beautifully formatted manner."""
...
class TestCountNodeAndEdges(unittest.TestCase):
    ...
    def test_three_taxa_tree(self):
        ...
        print_pretty_dict(edge_metrics)
