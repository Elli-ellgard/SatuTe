...
echo "---------------------------------------------------------"
$python satute_cli.py -iqtree $iqtree -msa $DIR/$msa  -alpha 0.05 -verbose
echo ""
...
$python satute_cli.py -msa $DIR/$msa -model JC+G4 -tree $DIR/${msa}.treefile -iqtree $iqtree -verbose
...
echo "---------------------------------------------------------"
#clean folder
$python satute_cli.py -msa $DIR/$msa -model JC+G4 -category 5 -iqtree=$iqtree -verbose
echo ""
...
echo "---------------------------------------------------------"
$python satute_cli.py -msa $DIR/$msa -model JC+G4 -category 2 -iqtree=$iqtree -verbose
echo ""
...
echo "---------------------------------------------------------"
$python satute_cli.py -msa $DIR/$msa -model JC+G4 -category 3 -iqtree=$iqtree -verbose
echo ""
...
echo "---------------------------------------------------------"
#create output
$python satute_cli.py -msa $DIR/$msa -model GTR -iqtree=$iqtree -verbose
PDIR=$(dirname $DIR)
if [ -e $DIR/${msa}*satute.tree ]; then
    rm -r $DIR/${msa}*satute*
fi
$python satute_cli.py -dir $DIR -category 4 -iqtree=$iqtree -verbose
echo ""
...
echo "---------------------------------------------------------"
#create output
$python satute_cli.py -msa $DIR/$msa -model GTR+G6 -iqtree=$iqtree -verbose
PDIR=$(dirname $DIR)
if [ -e $DIR/${msa}*satute.tree ]; then
    rm -r $DIR/${msa}*satute*
fi
$python satute_cli.py -dir $DIR -category 1 -iqtree=$iqtree -verbose
echo ""
